...
//            it('should return empty arrays for both', function() {
...
//
/////
//        ///this is an update and happens later
//        ///
...
//        });
        ...
        context('when calling buildListOfDependencies with dependent dagon modules', function() {
            it('should add their dependencies', function() {
                ...
                var result = new Mut([],['./../tests/TestModules/dependentModule1/dependentMod1.js'], pjson);
                console.log(result)
            });
        });
    });
