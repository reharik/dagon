    ...
    _createClass(RegistryDSL, [{
        ...
        value: function requireDirectory(dir) {
            ...
            fs.readdirSync(absoluteDir).filter(function (x) {
                ...
                return _this.dependencyDeclarations.push(_this.processFile(x, absoluteDir));
            });
            return this;
        }
        ...
        value: function groupAllInDirectory(dir, _groupName) {
            ...
            fs.readdirSync(absoluteDir).filter(function (x) {
                ...
                return _this2.dependencyDeclarations.push(_this2.processFile(x, absoluteDir, groupName));
            });
            return this;
        }
